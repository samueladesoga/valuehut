    ...
    training: [
        {
            ...
            streams: [
                ...
                {
                    id: '27bdeb3a-725a-4c89-8db7-a199368c66ad',
            ...
            streams: [
                {
                    ...
                    startDate: new Date('2024-09-19').toJSON(),
                    classType: 'Virtual',
                    endDate: new Date('2024-09-20').toJSON(),
                    time: '9:00 - 17:00 BST',
                    price: [
                        {
                            region: 'United Kingdom',
                ...
                },
                {
                    ...
                    startDate: new Date('2024-11-14').toJSON(),
                    classType: 'Virtual',
        ...
        },
        {
            ...
            streams: [
                {
                    id: 'c07eb5ab-c134-4b62-8278-442eff5d8637',
                ...
                },
                {
                    ...
                    startDate: new Date('2024-11-28').toJSON(),
                    endDate: new Date('2024-11-29').toJSON(),
                    time: '9:00 - 17:00 GMT',
                    classType: 'Virtual',
                    price: [
                        {
